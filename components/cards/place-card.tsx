...
import Image from 'next/image';  // ← CORRECTO: de Next.js


export function PlaceCard({ place }: { place: any }) {
  // Obtener URL de foto correctamente
  ...
  return (
    <div className="rounded-lg overflow-hidden bg-white border border-border hover:shadow-lg transition-shadow">
      {/* Imagen */}
