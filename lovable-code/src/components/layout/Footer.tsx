            ...
            <div className="mx-auto max-w-6xl px-6">
                <div className="grid gap-10 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link to="/promos" className="text-foreground/80 hover:text-primary">Promos bancarias</Link></li>
                            <li><Link to="/eventos" className="text-foreground/80 hover:text-primary">Eventos esta semana</Link></li>
                            <li><Link to="/dashboard" className="text-foreground/80 hover:text-primary">Para negocios</Link></li>
                        </ul>
                    </div>
                    <div>
                        <div className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
