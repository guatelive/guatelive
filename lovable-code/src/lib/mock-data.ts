// Mock data for GuateLive prototype
export type Place = {
  slug: string;
  name: string;
  category: string;
...
export const places: Place[] = [
  ...
  },
  {
    ...
    images: [
      img("photo-1436076863939-06870fe779c2", 1200, 800),
      img("photo-1514933651103-005eec06c04b", 800, 600),
      img("photo-1518176258769-f227c798150e", 800, 600),
      img("photo-1559526324-4b87b5e36e44", 800, 600),
    ],
    rating: 4.7,
    reviews: 1840,
    price: 2,
    ...
    phone: "+502 2245 0123",
    description: [
      "Cadejo nació en 2013 como un pequeño proyecto de tres amigos obsesionados con la cerveza artesanal. Hoy es probablemente la cervecería más querida de Guate, con un taproom en 4 Grados Norte que se llena cada tarde de jueves a domingo.",
      "El espacio es relajado, con paredes de ladrillo expuesto, mesas largas que invitan a compartir y un patio interior con luces colgantes. La oferta rotativa de 12 grifos siempre incluye sus clásicas (Cabra, Lover IPA) más experimentos de temporada.",
      "Vení por una pinta después del trabajo, quedate por la pizza al horno de leña y terminá con uno de sus shows en vivo los viernes.",
    ],
  },
  {
  ...
  },
  {
    slug: "rayuela-zona-1",
    name: "Rayuela",
    category: "Bar de barrio",
    zone: "Zona 1",
    image: img("photo-1514933651103-005eec06c04b"),
    rating: 4.6,
    reviews: 720,
    price: 2,
    tags: ["Centro histórico", "Cocteles"],
    distance: "6.2 km",
    openNow: true,
    hoursToday: "18:00 — 01:00",
  },
  {
    slug: "genetic-zona-4",
    name: "Genetic",
    ...
    zone: "Zona 4",
    image: img("photo-1571266028243-d220c6a1b9d8"),
    rating: 4.3,
    reviews: 612,
    price: 3,
    tags: ["Electrónica", "Noche"],
    distance: "4.1 km",
    openNow: false,
    hoursToday: "Abre a las 22:00",
  },
  {
    slug: "casa-chapina-zona-1",
    name: "Casa Chapina",
...
export type Featured = {
  ...
  cta: string;
  href: string;
  accent: "forest" | "terracotta" | "charcoal";
};
...
export const events: EventItem[] = [
  {
    ...
    venueSlug: "antigua-brewing-antigua",
    day: "22",
    month: "MAY",
    time: "20:00",
    price: "Q150",
    ...
    description:
      "Una noche íntima de jazz contemporáneo en la terraza con vista a los volcanes. El Quinteto Solar presenta material nuevo de su próximo disco más clásicos del bebop.",
  },
  {
  ...
  },
  {
    ...
    venueSlug: "cadejo-brewing-zona-4",
    day: "26",
    month: "MAY",
    time: "21:00",
    price: "Q80",
...
export const promos: Promo[] = [
  ...
  },
  {
    ...
    discount: 20,
    placeName: "Kacao",
    placeImage: img("photo-1555396273-367ea4eb4db5", 600, 400),
    days: "Vie y Sáb",
    expires: "30 sep 2025",
  },
  {
    ...
    bank: "BAC",
    discount: 25,
    placeName: "Café Barista",
    placeImage: img("photo-1554118811-1e0d58224f24", 600, 400),
    days: "Martes",
    expires: "31 dic 2025",
  },
];
...
export const banks = ["BAC", "BI", "Industrial", "Promerica", "G&T"] as const;
